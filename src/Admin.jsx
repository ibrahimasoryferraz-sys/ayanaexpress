  ...
  return (
    <div className="max-w-lg flex flex-col gap-5">
      ...
      <div className="rounded-2xl border p-4" style={{ borderColor: "#FCD34D", backgroundColor: "#FFFBEB" }}>
        <p className="text-sm" style={{ color: "#78350F" }}>
          Estas configurações são guardadas apenas neste protótipo. Numa loja em produção, ficam numa base de dados
          e a integração de pagamento real precisa de um fornecedor credenciado em Angola.
        </p>
      </div>
    </div>
  );
...
export default function AdminApp() {
  ...
  const titles = {
    ...
    categories: "Categorias", delivery: "Entrega", customers: "Clientes", settings: "Configurações",
  };
